...
public class BSMap{
    ...
    public String getDataString(){
        String r = "";
        try {
            r = "PAGE:"+this.pageMap.toString();
            r += ("/GOAL:"+this.goalMap.toString());
            r += ("/REVENUE:"+this.revenueMap.toString());
        }catch(Exception e){
        }
        return r;
    }
            ...
            TimerTask task = new TimerTask() {
                ...
                public void run() {
                    if( targetTracker != null ){
                        ...
                        if( WiseTracker.FLAG_OF_PRINT_LOG ){  Log.i("DEBUG_WISETRACKER", "BSMap.send() : targetTracker is Null."); }
                    }
                }
            };
